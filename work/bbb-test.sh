...
#	echo "firefox -a firefox -remote \"openURL($HOST/demo/demo1.jsp?action=create&username=$IP-$i,new-tab)\" &"
#	firefox -a firefox -remote "openURL($HOST/demo/demo1.jsp?action=create&username=$IP-$i,new-tab)" &
	echo firefox "$HOST/demo/demo1.jsp?action=create&username=$IP-$i,new-tab" 
	firefox "$HOST/demo/demo1.jsp?action=create&username=$IP-$i,new-tab" 
